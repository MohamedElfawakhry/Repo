...
#define LEDMXD_ROW8_PIN         GPIO_PORTA,GPIO_PIN8

#define LEDMXD_COL0_PIN         GPIO_PORTB,GPIO_PIN0
#define LEDMXD_COL1_PIN         GPIO_PORTB,GPIO_PIN1
#define LEDMXD_COL2_PIN         GPIO_PORTB,GPIO_PIN2
#define LEDMXD_COL3_PIN         GPIO_PORTB,GPIO_PIN3
#define LEDMXD_COL4_PIN         GPIO_PORTB,GPIO_PIN4
#define LEDMXD_COL5_PIN         GPIO_PORTB,GPIO_PIN5
#define LEDMXD_COL6_PIN         GPIO_PORTB,GPIO_PIN6
#define LEDMXD_COL7_PIN         GPIO_PORTB,GPIO_PIN7
#define LEDMXD_COL8_PIN         GPIO_PORTB,GPIO_PIN8
